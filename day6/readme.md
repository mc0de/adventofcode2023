...
- Don't hold the button at all (that is, hold it for `0` milliseconds_) at the start of the race. The boat won't move; it will have traveled `0` millimeters_ by the end of the race.
